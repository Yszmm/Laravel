            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/articledel/<?=$article['id']?>" class="btn btn-danger btn-sm">删除</a>
                                    <a href="/articleedit/<?=$article['id']?>" class="btn btn-info btn-sm">编辑</a>
                                </td>
                            </tr>
                            <?php }?>
                        </table>
                    ...
                    <div class="box-footer">
                        <a href="{{url('articleadd')}}" class="btn btn-primary">添加文章</a>
